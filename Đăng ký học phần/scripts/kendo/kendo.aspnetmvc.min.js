...
!function(e, define) {
    ...
    !function(e, t) {
        function n(t, n, r) {
            ...
            delete t.sort) : o[this.options.prefix + "sort"] = "",
            t.page && (o[this.options.prefix + "page"] = t.page,
            delete t.page),
            t.pageSize && (o[this.options.prefix + "pageSize"] = t.pageSize,
            delete t.pageSize),
            t.group ? (o[this.options.prefix + "group"] = e.map(t.group, function(e) {
                return e.field + "-" + e.dir
            }).join("~"),
            delete t.group) : o[this.options.prefix + "group"] = "",
            t.aggregate && (o[this.options.prefix + "aggregate"] = e.map(t.aggregate, function(e) {
                return e.field + "-" + e.aggregate
            }).join("~"),
            delete t.aggregate),
            t.filter ? (o[this.options.prefix + "filter"] = a(t.filter, r.encode),
            delete t.filter) : (o[this.options.prefix + "filter"] = "",
            delete t.filter),
            delete t.take,
            delete t.skip,
            i = new g(r),
        ...
        function s(e) {
            var t = {};
            return t[e.AggregateMethodName.toLowerCase()] = e.Value,
            t
        }
        function d(e) {
            var t, n, a, r = {};
        ...
        g.prototype = g.fn = {
            serialize: function(e, t, n) {
                ...
                for (r in t)
                    a = n ? n + "." + r : r,
                    this.serializeField(e, t[r], t, r, a)
            },
            ...
            serializeArray: function(e, t, n) {
                ...
                s = 0; o < t.length; o++)
                    ...
                    r = "[" + s + "]",
                    i = n + r,
                    this.serializeField(e, a, t, r, i),
                    s++
            },
            serializeValue: function(e) {
                return e instanceof Date ? e = this.stringifyDates ? c.stringify(e).replace(/"/g, "") : c.toString(e, "G", this.culture.name) : "number" == typeof e && (e = ("" + e).replace(v, this.decimalSeparator)),
                e
            }
        },
        f(!0, c.data, {
            ...
            transports: {
                "aspnetmvc-ajax": c.data.RemoteTransport.extend({
                    ...
                    read: function(e) {
                        ...
                        m(t) ? (n && (this.options.data = null),
                        !t.Data.length && n ? c.data.RemoteTransport.fn.read.call(this, e) : e.success(t)) : c.data.RemoteTransport.fn.read.call(this, e)
                    },
                    options: {
                        read: {
                            type: "POST"
        ...
        f(!0, c.data, {
            transports: {
                webapi: c.data.RemoteTransport.extend({
                    init: function(e) {
                        var t, a, r = this, i = (e || {}).stringifyDates;
                        e.update && (t = "string" == typeof e.update ? e.update : e.update.url,
                        e.update = f(e.update, {
                            url: function(n) {
                                return c.format(t, n[e.idField])
                            }
                        })),
                        e.destroy && (a = "string" == typeof e.destroy ? e.destroy : e.destroy.url,
                        e.destroy = f(e.destroy, {
                            url: function(t) {
        ...
        f(!0, c.data, {
            transports: {
                "aspnetmvc-server": c.data.RemoteTransport.extend({
                    ...
                    read: function(t) {
                        var n, a, r = this.options.prefix, i = [r + "sort", r + "page", r + "pageSize", r + "group", r + "aggregate", r + "filter"], o = RegExp("(" + i.join("|") + ")=[^&]*&?", "g");
                        a = location.search.replace(o, "").replace("?", ""),
                        a.length && !/&$/.test(a) && (a += "&"),
                        t = this.setup(t, "read"),
                        n = t.url,
                        n.indexOf("?") >= 0 ? (a = a.replace(/(.*?=.*?)&/g, function(e) {
                            return n.indexOf(e.substr(0, e.indexOf("="))) >= 0 ? "" : e
                        }),
                        n += "&" + a) : n += "?" + a,
                        n += e.map(t.data, function(e, t) {
                            return t + "=" + e
                        }).join("&"),
                        location.href = n
                    }
            ...
            transports: {
                "imagebrowser-aspnetmvc": n.data.RemoteTransport.extend({
                    ...
                    options: {
                        ...
                        parameterMap: function(e, t) {
                            return "read" != t && (e.EntryType = "f" === e.EntryType ? 0 : 1),
                            e
                        }
                    }
                })
...
function(e, define) {
    ...
    !function(e, t) {
        ...
        function r(e, t) {
            var n, a, r, i = {}, o = e.data(), s = t.length;
            for (r in o)
                a = r.toLowerCase(),
                n = a.indexOf(t),
        ...
        function o(e) {
            var t, n, a, r, i = {}, o = {}, s = e.FieldName, d = e.ValidationRules;
            for (a = 0,
            r = d.length; a < r; a++)
                t = d[a].ValidationType,
                n = d[a].ValidationParameters,
                i[s + t] = c(s, t, n),
                o[s + t] = u(d[a].ErrorMessage);
            return {
                rules: i,
                messages: o
            }
        ...
        var f = /("|\%|'|\[|\]|\$|\.|\,|\:|\;|\+|\*|\&|\!|\#|\(|\)|<|>|\=|\?|\@|\^|\{|\}|\~|\/|\||`)/g
          , p = {
            required: function(e) {
                var t, n, a, r = e.val(), i = e.filter("[type=checkbox]");
                return i.length && (t = i[0].name.replace(f, "\\$1"),
                n = "input:hidden[name='" + t + "']",
                a = i.next(n),
                a.length || (a = i.next("label.k-checkbox-label").next(n)),
